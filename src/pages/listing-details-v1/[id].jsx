...
const ListingDynamicDetailsV1 = () => {
  ...
  const { listen } = useSelector((state) => state.articles) || {};
  const router = useRouter();
  const [property, setProperty] = useState({});
  const id = router.query.id;

  // useEffect(() => {
  //   console.log(persistedProperties, "ddd")
  //   if (!id) <h1>Loading...</h1>;
  //   else setProperty(persistedProperties?.data.find((item) => item.id == id));
          ...
          <Gallery>
            <div className="row mb30">
              <div className="col-lg-7 col-xl-8">
                <div className="single_property_title mt30-767">
                  <h2>{persistedProperties?.propertyTitle}</h2>
                  <p>{persistedProperties?.address}</p>
                </div>
              </div>
            ...
            <div className="row">
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="spls_style_two mb30-520">
                      <Item
                        original={persistedProperties?.listImages[0]}
                        thumbnail={persistedProperties?.listImages[0]}
                        width={752}
                        height={450}
                      >
                        {({ ref, open }) => (
                          <div role="button" ref={ref} onClick={open}>
                            <Image
                              ...
                              src={persistedProperties.listImages[0]}
                              alt="1.jpg"
                            />
                          </div>
                        )}
              ...
              <div className="col-sm-5 col-lg-4">
                <div className="row">
                  {persistedProperties?.listImages?.map((val, i) => (
